      ...
      <footer className="px-5 py-10 text-center md:w-[90%] mx-auto relative mt-10 md:mt-16">
        ...
        <div className="flex gap-5 justify-center items-center flex-wrap md:gap-16 md:justify-end">
          <a
            ...
            className="flex gap-2 items-center outline-1 outline py-2 px-5 rounded-full group shadow-[0px_2px_10px_-5px_#ffffff] md:text-2xl md:px-">
            Descargar CV{" "}
          ...
          <div
            ...
            <a
              ...
              className="flex items-center justify-center p-2 outline-1 outline rounded-full text-xl duration-300 ease-in-out shadow-[0px_2px_10px_-3px_#ffffff]  hover:-translate-y-1 hover:bg-blue-500 hover:outline-none md:p-3">
              <FaLinkedinIn className="md:text-2xl" />
            </a>
            <a
              href="https://github.com/Lenas25"
              className="p-2 outline-1 outline  rounded-full text-xl duration-300 ease-in-out hover:-translate-y-1 hover:bg-[#000000]  hover:outline-none shadow-[0px_2px_10px_-3px_#ffffff] md:p-3">
              <FaGithub className="md:text-2xl" />
            </a>
            <a
              href="https://www.instagram.com/_lenasp"
              className="p-2 outline-1 outline  rounded-full text-xl duration-300 ease-in-out hover:-translate-y-1 hover:bg-[#F61558] hover:outline-none shadow-[0px_2px_10px_-3px_#ffffff] md:p-3">
