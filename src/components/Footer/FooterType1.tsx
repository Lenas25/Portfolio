    ...
    <footer className="px-5 py-10 text-center md:w-[70%] z-10 mx-auto mt-5">
      ...
      <div className="flex gap-5 justify-center items-center flex-wrap md:gap-16">
        ...
        <div className="flex items-center gap-2 md:gap-5">
          ...
          <button
            type="button"
            className="p-2 outline-1 outline  rounded-full text-xl duration-300 ease-in-out hover:-translate-y-1 hover:outline-none shadow-[0px_2px_10px_-3px_#ffffff] md:p-3">
