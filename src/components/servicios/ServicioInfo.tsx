...
export const ServicioInfo = ({
  ...
  return (
    <div className={`${s.servicecard}`}>
      <button
        type="button"
        className={`flex justify-between items-center group w-full text-xl font-semibold text-left md:text-2xl lg:text-4xl hover:text-purple transition duration-300 ease-in-out ${
