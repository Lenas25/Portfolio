...
export const Projects = () => {
  return (
    <SpotlightCard
      className="custom-spotlight-card row-start-3 lg:col-span-2 lg:row-span-1 md:row-start-3 md:col-span-2 lg:col-start-3 lg:row-start-3 bg-gradient-to-tl from-[#d4c6f870] from-[29.18%] to-[#ffffffa1] to-[118.51%] rounded-3xl p-8 group relative flex flex-col justify-between gap-5 lg:gap-10"
